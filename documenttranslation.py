...
key = "<translator resource key>"
endpoint = "translator resource endpoint>"
sourceUri = "<replace with your source container SAS token (Your source container or blob must designate read and list access.)>"
targetUri = "<replace with your target container SAS token (Your target container or blob must designate write and list access.)> "
targetLanguage = "vi"
